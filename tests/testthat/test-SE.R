...
test_that("SMD.SE from OR", {
  expect_equal(SMD.SE_from_OR.CI(0.31, 5.68), 0.41, tolerance = 0.01)
  expect_equal(SMD.SE_from_OR.CI(1.07, 26.5), 0.452, tolerance = 0.01)
  expect_equal(SMD.SE_from_OR.CI(0.18, 1.89), 0.331, tolerance = 0.01)
})
